                                    ...
                                    138 	.globl _P0
                                    139 	.globl _led_init
                                    140 	.globl _led_write
                                    141 	.globl _led_all_off
                                    142 	.globl _led_all_on
                                    143 ;--------------------------------------------------------
      ...
      000000                        147 	.org 0x0000
                           ...
                           00008E   174 _AUXR	=	0x008e
                           0000D6   175 _T2H	=	0x00d6
                           0000D7   176 _T2L	=	0x00d7
                                    177 ;--------------------------------------------------------
      ...
      000000                        181 	.org 0x0000
                           ...
                           0000A1   275 _SDA	=	0x00a1
                           0000A0   276 _SCL	=	0x00a0
                           000094   277 _DQ	=	0x0094
                           0000B3   278 _S4	=	0x00b3
                           0000B2   279 _S5	=	0x00b2
                           0000B1   280 _S6	=	0x00b1
                                    281 ;--------------------------------------------------------
      ...
      000000                        285 	.ds 8
                                    ...
                                    348 	.area CSEG    (CODE)
                                    349 ;------------------------------------------------------------
                                    350 ;Allocation info for local variables in function 'Select_HC573'
                                    351 ;------------------------------------------------------------
                                    352 ;channel                   Allocated to registers r7 
                                    353 ;temp                      Allocated to registers r7 
                                    354 ;------------------------------------------------------------
                                    355 ;	led.c:8: static void Select_HC573(u8 channel)
                                    356 ;	-----------------------------------------
                                    357 ;	 function Select_HC573
                                    358 ;	-----------------------------------------
      00022B                        359 _Select_HC573:
                           000007   360 	ar7 = 0x07
                           000006   361 	ar6 = 0x06
                           000005   362 	ar5 = 0x05
                           000004   363 	ar4 = 0x04
                           ...
                           000001   366 	ar1 = 0x01
                           000000   367 	ar0 = 0x00
      00022B AF 82            [24]  368 	mov	r7,dpl
                                    369 ;	led.c:11: P2 = (P2 & 0x1F) | 0x00;       /* 先清空P2高3位 */
      00022D 53 A0 1F         [24]  370 	anl	_P2,#0x1f
                                    371 ;	led.c:12: temp = channel << 5;             /* 通道号左移5位映射到高3位 */
      000230 EF               [12]  372 	mov	a,r7
      000231 C4               [12]  373 	swap	a
      000232 23               [12]  374 	rl	a
      000233 54 E0            [12]  375 	anl	a,#0xe0
      000235 FF               [12]  376 	mov	r7,a
                                    377 ;	led.c:13: P2 = (P2 & 0x1F) | temp;        /* 设置对应通道 */
      000236 E5 A0            [12]  378 	mov	a,_P2
      000238 54 1F            [12]  379 	anl	a,#0x1f
      00023A 4F               [12]  380 	orl	a,r7
      00023B F5 A0            [12]  381 	mov	_P2,a
                                    382 ;	led.c:14: }
      00023D 22               [24]  383 	ret
                                    384 ;------------------------------------------------------------
                                    385 ;Allocation info for local variables in function 'led_init'
                                    386 ;------------------------------------------------------------
                                    387 ;	led.c:19: void led_init(void)
                                    388 ;	-----------------------------------------
                                    389 ;	 function led_init
                                    390 ;	-----------------------------------------
      00023E                        391 _led_init:
                                    392 ;	led.c:21: led_all_off();
                                    393 ;	led.c:22: }
      00023E 02 02 52         [24]  394 	ljmp	_led_all_off
                                    395 ;------------------------------------------------------------
                                    396 ;Allocation info for local variables in function 'led_write'
                                    397 ;------------------------------------------------------------
                                    398 ;value                     Allocated to registers r7 
                                    399 ;------------------------------------------------------------
                                    400 ;	led.c:28: void led_write(u8 value)
                                    401 ;	-----------------------------------------
                                    402 ;	 function led_write
                                    403 ;	-----------------------------------------
      000241                        404 _led_write:
                                    405 ;	led.c:30: P0 = ~value;                     /* 取反后输出 (低电平点亮) */
      000241 E5 82            [12]  406 	mov	a,dpl
      000243 F4               [12]  407 	cpl	a
      000244 F5 80            [12]  408 	mov	_P0,a
                                    409 ;	led.c:31: Select_HC573(4);                 /* 选中LED锁存器通道 */
      000246 75 82 04         [24]  410 	mov	dpl,#0x04
      000249 12 02 2B         [24]  411 	lcall	_Select_HC573
                                    412 ;	led.c:32: Select_HC573(0);                 /* 关闭通道选择，锁存数据 */
      00024C 75 82 00         [24]  413 	mov	dpl,#0x00
                                    414 ;	led.c:33: }
      00024F 02 02 2B         [24]  415 	ljmp	_Select_HC573
                                    416 ;------------------------------------------------------------
                                    417 ;Allocation info for local variables in function 'led_all_off'
                                    418 ;------------------------------------------------------------
                                    419 ;	led.c:38: void led_all_off(void)
                                    420 ;	-----------------------------------------
                                    421 ;	 function led_all_off
                                    422 ;	-----------------------------------------
      000252                        423 _led_all_off:
                                    424 ;	led.c:40: P0 = 0xFF;                       /* 全部输出高电平 (LED灭) */
      000252 75 80 FF         [24]  425 	mov	_P0,#0xff
                                    426 ;	led.c:41: Select_HC573(4);
      000255 75 82 04         [24]  427 	mov	dpl,#0x04
      000258 12 02 2B         [24]  428 	lcall	_Select_HC573
                                    429 ;	led.c:42: Select_HC573(0);
      00025B 75 82 00         [24]  430 	mov	dpl,#0x00
                                    431 ;	led.c:43: }
      00025E 02 02 2B         [24]  432 	ljmp	_Select_HC573
                                    433 ;------------------------------------------------------------
                                    434 ;Allocation info for local variables in function 'led_all_on'
                                    435 ;------------------------------------------------------------
                                    436 ;	led.c:48: void led_all_on(void)
                                    437 ;	-----------------------------------------
                                    438 ;	 function led_all_on
                                    439 ;	-----------------------------------------
      000261                        440 _led_all_on:
                                    441 ;	led.c:50: P0 = 0x00;                       /* 全部输出低电平 (LED亮) */
      000261 75 80 00         [24]  442 	mov	_P0,#0x00
                                    443 ;	led.c:51: Select_HC573(4);
      000264 75 82 04         [24]  444 	mov	dpl,#0x04
      000267 12 02 2B         [24]  445 	lcall	_Select_HC573
                                    446 ;	led.c:52: Select_HC573(0);
      00026A 75 82 00         [24]  447 	mov	dpl,#0x00
                                    448 ;	led.c:53: }
      00026D 02 02 2B         [24]  449 	ljmp	_Select_HC573
                                    450 	.area CSEG    (CODE)
                                    451 	.area CONST   (CODE)
                                    452 	.area XINIT   (CODE)
