...
static __bit Rx_flag = 0;            /* 串口接收标志 */
static u8 Rx_data;                   /* 串口接收数据 */
static u16 update_tick = 0;          /* 温度更新计数器 */
static __bit flag_update = 1;        /* 温度更新标志 */
 ...
 *   0~255 -> 0~8000 (对应 0.00C ~ 80.00C)
 *
 * 模式2 (DS18B20):
 *   读取 DS18B20 真实温度
 *   原始值 * 6.25 -> 温度值 * 100
 *   例如: raw=401 (25.0625C) -> 401*6.25~2506 -> 25.06C
